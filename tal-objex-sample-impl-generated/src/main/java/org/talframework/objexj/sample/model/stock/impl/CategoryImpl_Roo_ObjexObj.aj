...
privileged aspect CategoryImpl_Roo_ObjexObj {
    ...
    public Product CategoryImpl.getProductById(Object id) {
        ...
        return ObjectUtils.getObject(this, id, org.talframework.objexj.sample.api.stock.Product.class);
    }
    ...
    public Category CategoryImpl.getCategoryById(Object id) {
        ...
        return ObjectUtils.getObject(this, id, org.talframework.objexj.sample.api.stock.Category.class);
    }
